...
export default {
  ...
  s3AccessKeyId: getOptionalEnvVar("S3_ACCESS_KEY_ID"),
  s3SecretAccessKey: getOptionalEnvVar("S3_SECRET_ACCESS_KEY"),
  s3Region: getOptionalEnvVar("S3_REGION", "us-east-1"),
  s3ForcePathStyle: env.get("S3_FORCE_PATH_STYLE").default("false").asBool(),
