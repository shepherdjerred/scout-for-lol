...
import { diff } from "jsr:@std/internal@^1.0.8/diff";
import { diffStr } from "jsr:@std/internal@^1.0.8/diff-str";
import { buildMessage } from "jsr:@std/internal@^1.0.8/build-message";
