...
import { fromFileUrl } from "jsr:@std/path@^1.1.0/from-file-url";
...
import { ensureFile, ensureFileSync } from "jsr:@std/fs@^1.0.17/ensure-file";
import { assert } from "jsr:@std/assert@^1.0.13/assert";
import { AssertionError } from "jsr:@std/assert@^1.0.13/assertion-error";
import { equal } from "jsr:@std/assert@^1.0.13/equal";
import {
  escapeStringForJs,
  getErrorMessage,
  getIsUpdate,
