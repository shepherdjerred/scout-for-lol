import { z } from "zod";
import { type Champion, ChampionSchema } from "@scout-for-lol/data/model/champion.ts";
import { RosterSchema } from "@scout-for-lol/data/model/roster.ts";
import { TeamSchema } from "@scout-for-lol/data/model/team.ts";
