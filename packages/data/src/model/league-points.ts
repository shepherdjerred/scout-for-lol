...
import { z } from "zod";
import { numberOfDivisions } from "@scout-for-lol/data/model/division.ts";
import type { Rank } from "@scout-for-lol/data/model/rank.ts";
import type { Tier } from "@scout-for-lol/data/model/tier.ts";
