  ...
  try {
    ...
    return new Response(bodyString, {
      ...
      headers: {
        "Content-Type": "application/json",
        "Access-Control-Allow-Origin": "*",
        "Cache-Control": "public, max-age=3600", // Cache for 1 hour (match data is immutable)
      },
    });
  } catch (error) {
    ...
    const message = result.success ? result.data.message : "Failed to get object";
    return new Response(
      JSON.stringify({
        error: message,
      }),
