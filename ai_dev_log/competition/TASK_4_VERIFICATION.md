 ...
 */
export function rankToNumericValue(tier: string, division: string, lp: number): number;

/**
 * Calculate LP difference between two ranks
 */
export function calculateRankClimb(startRank: RankData, endRank: RankData): number;
```
